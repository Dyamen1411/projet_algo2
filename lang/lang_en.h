...
#define LANG_OPT_DESCRIPTION__INITIAL "Set the maximal number of significant " \
  "initial letters for words to " LANG_OPT__PARAMETER_VALUE_CAPS ". 0 means " \
...
#define LANG_OPT_DESCRIPTION__TOP "Set the maximal number of words to print " \
  "to " LANG_OPT__PARAMETER_VALUE_CAPS ". 0 means all the words. Default is " \
...
#define LANG_WS__LONG_DESCRIPTION \
  ...
  _MAKE_UNDERLINED(LANG_OPT__PARAMETER_FILES_LOWER) ". Each of the words " \
  "listed is accompanied by a pattern indicating in which " \
  _MAKE_UNDERLINED(LANG_OPT__PARAMETER_FILES_LOWER) " it appears and the " \
  "total number of its occurrences in the " \
  _MAKE_UNDERLINED(LANG_OPT__PARAMETER_FILES_LOWER) ".\nA word is, by " \
  ...
  _MAKE_UNDERLINED(LANG_OPT__PARAMETER_FILES_LOWER) ". Only shared words are " \
  "listed. The printed list is sorted in descending order of the number of " \
  _MAKE_UNDERLINED(LANG_OPT__PARAMETER_FILES_LOWER) " in which the words " \
  ...
  _MAKE_UNDERLINED(LANG_OPT__PARAMETER_FILES_LOWER) " or not; the total " \
  "number of occurrences; the word.The tab character is used as field " \
  "separator.\nRead the standard input for any of the " \
  _MAKE_UNDERLINED(LANG_OPT__PARAMETER_FILES_LOWER) " which is \"-\"."
